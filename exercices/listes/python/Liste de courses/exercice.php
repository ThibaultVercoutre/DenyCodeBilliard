...
<body>
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                <code class="code_rouge">def get_shopping_list():</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspshopping_list = []</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspwhile True:</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspitem = input("Ajoutez un article à la liste de courses (tapez 'fin' pour terminer) : ")</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspif item.lower() == 'fin':</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspbreak</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspshopping_list.append(item)</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspreturn shopping_list</code><br />
            </div>
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                <code class="code_gris">def get_shopping_list():</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspshopping_list = []</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspwhile True:</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspitem = input("Ajoutez un article Ã  la liste de courses (tapez 'fin' pour terminer) : ")</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspif item.lower() == 'fin':</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspbreak</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspshopping_list.append(item)</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn shopping_list</code><br />
                <br />
                <code class="code_rouge">def sort_alphabetically(shopping_list):</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list)</code><br />
            </div>
            <div class="explication_text">
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn shopping_list</code><br />
                <br />
                <code class="code_gris">def sort_alphabetically(shopping_list):</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list)</code><br />
                <br />
                <code class="code_rouge">def sort_by_length(shopping_list):</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list, key=len)</code><br />
            </div>
            <div class="explication_text">
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list)</code><br />
                <br />
                <code class="code_gris">def sort_by_length(shopping_list):</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list, key=len)</code><br />
                <br />
                <code class="code_rouge">def display_shopping_list(shopping_list):</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspfor index, item in enumerate(shopping_list, start=1):</code><br />
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn sorted(shopping_list, key=len)</code><br />
                <br />
                <code class="code_gris">def display_shopping_list(shopping_list):</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspfor index, item in enumerate(shopping_list, start=1):</code><br />
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspprint(f"{index}. {item}")</code><br />
                <br />
                <code class="code_rouge">def get_purchased_item(shopping_list):</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspdisplay_shopping_list(shopping_list)</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspchoice = int(input("Entrez le numéro de l'article que vous avez achetÃ© : "))</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspreturn shopping_list[choice - 1]</code><br />
            </div>
            <div class="explication_text">
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspprint(f"{index}. {item}")</code><br />
                <br />
                <code class="code_gris">def get_purchased_item(shopping_list):</code><br />
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn shopping_list[choice - 1]</code><br />
                <br />
                <code class="code_rouge">def remove_purchased_item(shopping_list, item):</code><br />
                <code class="code_rouge">&nbsp&nbsp&nbsp&nbspshopping_list.remove(item)</code><br />
            </div>
            <div class="explication_text">
    ...
    <div class="accordion">
        ...
        <div class="accordion-content" id="etape_' . $i .'">
            <div class="codes_ex code">
                ...
                <code class="code_gris">&nbsp&nbsp&nbsp&nbspreturn shopping_list[choice - 1]</code><br />
                <br />
                <code class="code_gris">def remove_purchased_item(shopping_list, item):</code><br />
    ...
    <div id="code_final" class='code'>
        ...
        <br />
        <code>&nbsp&nbsp&nbsp&nbspprint("Bravo ! Vous avez terminÃ© vos achats.")</code><br />
        <br />
