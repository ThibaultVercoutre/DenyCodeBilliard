...
<div id="titre_exo_week">
    ...
    <fieldset>
        ...
        <table>
            <caption>Table des boissons</caption>
            <tr>
            ...
            <tr>
                <th scope="row">Karmeliet</th>
                <td>Alcool</td>
                <td>25cl</td>
                <td>2,5€</td>
            </tr>
            <tr>
                <th scope="row">Triple Karmeliet</th>
                <td>Alcool</td>
                <td>25cl</td>
                <td>2,5€</td>
            </tr>
            <tr>
                <th scope="row">Triple Secret des Moines</th>
                <td>Alcool</td>
                <td>25cl</td>
                <td>2,5€</td>
            </tr>
            <tr>
                <th scope="row">Jagger Bomb</th>
                <td>Alcool</td>
                <td>30cl</td>
                <td>7€</td>
            </tr>
    ...
    <fieldset>
        <legend>Niveau 3</legend>
        <p>
            Deny aime beaucoup la vie, mais aime aussi beaucoup la santé. Il refuse donc de boire plus de 3 verres d'alcool dans la soirée.
        </p>
    </fieldset>
